document.addEventListener("DOMContentLoaded",function(){var a=document.createElement("style");a.type="text/css",a.innerText=`
  body {
  ...
  .heart:after {
  ...
  }`,document.head.appendChild(a);var e,n,t=new Date,a=t.getMonth()+1,t=t.getDate();9!==a&&10!==a&&11!==a||((e=document.createElement("div")).className="leaves",e.innerHTML=`
      <i class=leaf></i>
      <i class=leaf></i>
      ...
      <i class=leaf-1920px></i>`,document.body.insertBefore(e,document.body.childNodes[0])),12!==a&&1!==a&&2!==a||((n=document.createElement("div")).className="snow",n.innerHTML=`
      ...
      <i class=snow_flake-1920px></i>`,document.body.insertBefore(n,document.body.childNodes[0]),12===a&&function(){var a=document.createElement("div");a.id="christmasLights";var e=document.createElement("ul");e.setAttribute("class","lightrope");for(var n=0;n<50;n++){var i=document.createElement("li");e.appendChild(i)}a.appendChild(e),document.body.insertBefore(a,document.body.childNodes[0])}(),2===a&&14===t&&function(){var s=document.createElement("div");document.body.insertBefore(s,document.getElementById("board"));var l=3e3,r=[],c=!1,p=null;document.onmousedown=function(a){c=!0,p=a},document.onmouseup=function(a){c=!1},document.onmousemove=function(a){p=a},document.ontouchstart=function(a){c=!0,p=a.touches[0]},document.ontouchend=function(a){c=!1},document.ontouchmove=function(a){p=a.touches[0]};var t=Date.now();setInterval(function(){var a=Date.now(),e=a-t;for(i in t=a,r){var n=r[i];n.time-=e,0<n.time?(n.y-=.5,n.style.top=n.y+"px",n.style.left=n.x+n.direction*n.bound*Math.sin(n.y*n.scale/30)/n.y*100+"px"):(n.parentNode.removeChild(n),r.splice(i,1))}},5),setInterval(function(){var a,e,n,i,t,o;c&&(t=1-2*Math.round(Math.random()),o=Math.random()*Math.random()*.8+.2,i=30+20*Math.random(),a=p.pageX-s.offsetLeft+0,e=p.pageY-s.offsetTop+195,n=i,i=t,t=o,(o=document.createElement("div")).setAttribute("class","heart"),s.appendChild(o),o.time=l,o.x=a,o.y=e,o.bound=n,o.direction=i,o.style.left=o.x+"px",o.style.top=o.y+"px",o.scale=t,o.style.transform="scale("+t+","+t+")",(r=null===r?[]:r).push(o))},100)}())});